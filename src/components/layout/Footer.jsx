      ...
      <div className="mx-auto grid w-full max-w-6xl gap-10 px-4 py-14 sm:px-6 md:grid-cols-3 lg:px-8">
        <div>
          <div className="flex items-center gap-2.5">
            <Logo size={28} />
            <h3 className="text-xl font-bold text-white">NaukriNote</h3>
          </div>
          <p className="mt-3 text-sm text-gray-400">Built for the construction industry.</p>
          <p className="mt-4 text-xs text-gray-500">© 2025 NaukriNote. All rights reserved.</p>
        </div>
        <div>
        ...
        <div>
          ...
          <p className="mt-1 text-sm text-brand-400">support@naukrinote.com</p>
        </div>
      </div>
