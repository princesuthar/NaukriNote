      ...
      <main>
        <section className="relative overflow-hidden bg-surface-400 px-4 py-20 pt-32 text-center sm:px-6 lg:px-8">
          ...
          <div className="relative mx-auto w-full max-w-3xl animate-slide-up">
            <h1 className="text-4xl font-bold text-white sm:text-5xl">About <span className="text-gradient">NaukriNote</span></h1>
        ...
        <section className="bg-surface-500 px-4 py-20 sm:px-6 lg:px-8">
          <div className="mx-auto w-full max-w-3xl">
            <div className="glass-card p-8 text-center sm:p-12">
              ...
              <p className="mt-6 leading-8 text-gray-400">Construction contractors in India manage large, mobile workforces across multiple sites with very few digital tools. NaukriNote was built to solve this — making attendance, payroll, and worker management simple, fast, and mobile-friendly.</p>
            </div>
          </div>
        </section>
      </main>
